...
RUN set -eux; \
    ...
    # Wave B F1 (audit 2026-05-11) — verify the binary against the
    # SHA-256 pinned in scripts/tailwind-sha256.txt before trusting it.
